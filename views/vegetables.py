...
#
# Only One ajaxRoute per microfrontend inside a form,
# make shure you hit a stored procedure.
#
# in case of transactions run in a different app
# predict_implementation_id(source_fraction_id, product_id, date) returns list()
# 
# 
#---------------------------------------------------------------------------#
